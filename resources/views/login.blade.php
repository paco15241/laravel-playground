    ...
    <div class="bg-gray-200 min-h-screen font-sans">
        <div class="max-w-sm mx-auto px-6">
            ...
            <div class="w-full relative">
                ...
                <span>Desined By <a class="text-blue-500" href="https://twitter.com/framansi">@framansi</a></span>
                </div>
                <div class="text-center font-semibold text-black">
                    登入噢，<a href='/register' class="hover:text-blue-600">还没有账号点这注册</a>
                </div>
                
                <form class="mt-8" x-data="alpineInit()" x-init="init()">
                    ...
                    -->
                    <button id="submit" class="mt-3 text-lg font-semibold  bg-gray-800 w-full text-white rounded-lg px-6 py-3 block shadow-xl hover:text-white hover:bg-black">
                        登入
                    </button>
                    </div>
                </form>
